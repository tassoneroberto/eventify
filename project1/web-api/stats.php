...
$result_num_query=mysqli_query($conn, "SELECT query FROM api_login WHERE api_key='$_SESSION[api_key]'");
while($row = $result_num_query->fetch_assoc()) {$num_query=$row["query"];}
$total_num_query=0;
...
window.onload = function () {
	var chartQueries = new CanvasJS.Chart("queriesChart",
	{
		theme: "theme2",	
		data: [
		{       
			...
			dataPoints: [
				{  y: <?php echo $num_query ?>, indexLabel: "Local app executed queries" },
				{  y: <?php echo $total_num_query-$num_query ?>, indexLabel: "Other apps executed queries" },
			]
		}
		]
	});
...
<div class="mdl-grid demo-content">
  <div class="demo-card-wide mdl-card mdl-shadow--2dp">
    <h3>System</h3>
    <div id="queriesChart" style="height: 300px; width: 100%;"></div>
    <table>
      <tr>
      ...
      <tr>
        <td>Executed queries with this API key:</td>
        <td><?php echo $num_query; ?></td>
      </tr>
    </table>
  </div>
</div>
