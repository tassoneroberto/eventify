...
<div id="login-page" class="row">
  <div class="col s12 z-depth-4 card-panel">
    <form class="login-form" action="managepanel.php?page=home" method="post">
      <div class="row">
        <div class="input-field col s12 center"> <img src="images/logo.png" alt="" class="responsive-img valign profile-image-login">
          <p class="center login-form-text">API Login Panel</p>
        </div>
      </div>
      ...
      <div class="row">
        <div class="input-field col s12"> <a class="btn waves-effect waves-light col s12" href="request.php">Request API key</a> </div>
      </div>
      <hr />
      <div class="row">
        <div class="input-field col s12"> <a class="btn waves-effect waves-light col s12" href="adminlogin.php">Admin login</a> </div>
      </div>
    </form>
  </div>
</div>
